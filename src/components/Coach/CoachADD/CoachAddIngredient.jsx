...
import { useCoachAddIngredient } from '../../../hook/Coach/useCoachAddIngredient';
import DargDrop from '../../DargDrop';
import { ExitToApp } from '@mui/icons-material';

const CoachAddIngredient = ({ handleCloseModal }) => {  // Accept handleCloseModal as prop
    const [name, setName] = useState('');
    const [image, setImage] = useState(null);

    const { mutate: addIngredient } = useCoachAddIngredient();
                ...
                <div className='m-2 md:m-10 p-2 md:p-10 bg-white rounded-3xl drop-shadow-2xl backdrop-filter bg-opacity-95'>
                    ...
                    <div className='mt-6'>
                        ...
                        <div className='flex justify-end items-center'>
                            <button
                                className='p-4 bg-black text-white rounded-xl mt-2 button-effect border-2'
...
export default CoachAddIngredient;
