...
//                                                 <div className="">
//                                                     <img className='h-48 w-48' src={`https://de68-138-199-7-163.ngrok-free.app/Uploads/${ing.image}`} alt="Minecraft" />
//                                                 </div>
//                                                 <div className=" px-5">
                                    ...
                                    {allIngredients?.ingredient?.map((ing) => {
                                        ...
                                        return (
                                            <div key={ing.id} className="bg-gray-500 border-1 border-black overflow-hidden w-auto rounded-xl m-3 card-effect hover:cursor-pointer h-64"
                                                onClick={() => handleCheckboxChange(ing.id)}>
                                                <div className="">
                                                    <img className='h-48 w-48' src={`https://de68-138-199-7-163.ngrok-free.app/Uploads/${ing.image}`} alt={ing.name} />
                                                </div>
                                                <div className=" px-5">
                                                    <strong className="flex justify-between font-extrabold mt-3">
                                                        <span className='text-white text-sm'>
