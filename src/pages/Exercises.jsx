...
import AddExerciseToType from '../components/ADD/AddExerciseToType'
            ...
            {allExercise?.map((exercise) => {
              return <>
                <div key={exercise.id} className='border-2 border-black rounded-xl flex'>
                  <img src={`https://de68-138-199-7-163.ngrok-free.app/Uploads/${exercise.gif}`} alt="Exercise" className='w-48 h-48 m-4 border-1 border-gray-500 rounded-xl ' />
