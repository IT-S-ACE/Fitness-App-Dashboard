...
export const gridProductImage = (props) => (
  <div>
    <img
      className="rounded-xl h-20 md:ml-3"
      // src={props.ProductImage}
      src={`https://142c-89-39-107-204.ngrok-free.app/Uploads/${props.Product}`}
...
const gridEmployeeProfile = (props) => (
  <div className="flex items-center gap-2">
    <img
      ...
      src={`https://142c-89-39-107-204.ngrok-free.app/Uploads/${props.EmployeeImage}`}
      alt={props.Name}
    />
    <p>{props.Name}</p>
  </div>
...
const colorsTemplate = (props) => (
  <div style={{ display: 'flex', gap: '5px', flexWrap : 'wrap'}}>
    {props.Colors.map((color, index) => (
      <div key={index} style={{ backgroundColor: color, width: '15px', height: '15px', borderRadius: '50%' }}></div>
    ))}
  </div>
);
...
export const productGrid = [
  ...
  { headerText: 'Product', width: '150', template: gridProductImage, textAlign: 'Center' },
  ...
  { field: 'Brand', headerText: 'Brand', width: '100', textAlign: 'Center' },
  { field: 'Price', headerText: 'Price', width: '100', textAlign: 'Center' },
  { field: 'ExpirationDate', headerText: 'Expiration Date', width: '150', textAlign: 'Center' },
  { field: 'Stock', headerText: 'Stock', width: '150', textAlign: 'Center' },
  { field: 'Protein', headerText: 'Protein', width: '150', textAlign: 'Center' },
  { field: 'Creatine', headerText: 'Creatine', width: '150', textAlign: 'Center' },
  { field: 'SalesCount', headerText: 'Sales Count', width: '150', textAlign: 'Center' },
  { field: 'ViewCount', headerText: 'View Count', width: '150', textAlign: 'Center' },
  { field: 'Colors', headerText: 'Colors', width: '150', textAlign: 'Center' , template: colorsTemplate },
  { field: 'Sizes', headerText: 'Sizes', width: '150', textAlign: 'Center' , template: sizesTemplate},
  { field: 'ProductID', headerText: 'Product ID', width: '120', textAlign: 'Center', isPrimaryKey: true },
];
