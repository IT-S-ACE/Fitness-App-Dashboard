...
const api = axios.create({
    baseURL: 'https://142c-89-39-107-204.ngrok-free.app/api'
...
export const DeleteArticle = async ({ articleID }) => {
    return await api.delete(`/admin/articl/deleteArticl/${articleID}`);
};

export const DeleteIngredient = async ({ ingredientID }) => {
    return await api.delete(`/admin/ingredient/destroy/${ingredientID}`);
};

export const SalesByMonths = async (detail) => {
    return await api.post('/admin/report/salesByMonth', detail);
};
